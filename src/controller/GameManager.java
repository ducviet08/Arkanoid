...
//            this.activeMixPowerUp = new StickyPaddlePowerUp("/images/slow_ball.png", paddle.getX(), paddle.getY(), 0, 0, 10000, ball);
...
public class GameManager {
    ...
    public void setActivePowerUpByName(String className) {
        ...
        if (className.equals("ExpandPaddlePowerUp")) {
            this.activePaddlePowerUp = new ExpandPaddlePowerUp("", 0, 0, 0, 0, 5000);
            activePaddlePowerUp.applyEffect(paddle);

        } else if (className.equals("FastBallPowerUp")) {
            this.activeBallPowerUp = new FastBallPowerUp("", 0, 0, 0, 0, 5000, ball);
            activeBallPowerUp.applyEffect(paddle);

        } else if (className.equals("FireBallPowerUp")) {
            this.activeBallPowerUp = new FireBallPowerUp("", 0, 0, 0, 0, 5000, ball);
            activeBallPowerUp.applyEffect(paddle);

        } else if (className.equals("ShrinkPaddlePowerUp")) {
            this.activePaddlePowerUp = new ShrinkPaddlePowerUp("", 0, 0, 0, 0, 5000);
            activePaddlePowerUp.applyEffect(paddle);

        } else if (className.equals("StickyPaddlePowerUp")) {
            this.activeMixPowerUp = new StickyPaddlePowerUp("", 0, 0, 0, 0, 10000, ball);
            activeMixPowerUp.applyEffect(paddle);
        }
    }
}